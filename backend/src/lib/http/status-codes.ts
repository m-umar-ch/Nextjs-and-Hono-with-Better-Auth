export const HTTP = {
   ...
   *
   * Request entity is larger defined b: server, the server might close the connection or return an Retry-After header field.
   */
   ...
   *
   * The range specified by the Range header field in the request t b: fulfilled, it's possible that the range is outside the size of the target URI's data.
   */
